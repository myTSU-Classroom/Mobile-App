...
import com.example.mytsuclassroom.databinding.FragmentRegisterEmailBinding
...
class RegisterEmailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnNext.setOnClickListener {
            navController.navigate(R.id.action_registerEmailFragment_to_registerPhoneFragment)
        }

...
import com.example.mytsuclassroom.databinding.FragmentRegisterSelectBinding
...
class RegisterSelectFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnNext.setOnClickListener {
            navController.navigate(R.id.action_registerSelectFragment_to_registerGradeFragment)
        }
